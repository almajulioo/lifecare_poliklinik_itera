...
<div class="pb-20 bg-white min-h-screen">
    ...
    <div class="bg-white px-4 pt-4 pb-4 border-b border-gray-100 sticky top-0 z-10">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-lg font-bold text-gray-900">Tambah Obat</h1>
        </div>
        <p class="text-xs text-gray-500 pl-8">Tambahkan obat khusus untuk diri Anda</p>
    </div>
    ...
    <div class="px-4 pt-6 space-y-4">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p class="text-xs text-blue-700">
                <strong>💡 Tip:</strong> Anda bisa menambah obat yang tidak ada di daftar admin. Obat ini hanya akan muncul di jadwal Anda sendiri.
            </p>
        </div>

        {{-- FORM --}}
        <form action="{{ route('app.medicines.store') }}" method="POST" class="space-y-4">
            @csrf
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-sm text-gray-900">
                                <span class="medicine-name">Nama Obat</span>
                            </h3>
                            <p class="text-xs text-gray-600 mt-1">
                                <span class="medicine-dose">500</span> 
                                <span class="medicine-unit">mg</span>
                            </p>
                            <p class="text-xs text-gray-500 mt-2 medicine-notes" style="display:none;"></p>
                        </div>
                    </div>
                </div>
            </div>
